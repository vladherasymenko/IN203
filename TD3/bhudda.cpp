...
struct Complex //non parallélisable
{
    float re, im;    
    Complex() : re(0.), im(0.)
    {}
...
bool test_mandelbrot_divergent( int maxIter, const Complex& c) //non parallélisable
{
    Complex z{0.,0.};
...
void save_image( const std::string &filename, unsigned width, unsigned height, const std::vector<unsigned char> &img )  //non parallélisable
{
